...
def main():
    ...
    # st.sidebar.markdown("<h1 style='color: #131921; font-size: 26px;'>Select Option</h1>", unsafe_allow_html=True)
    # menu_selection = st.sidebar.radio("", ("Scrap Data", "Visualization Page", "Recommendation Page"))
