...
def visualize_data():
    ...
    # st.write(data.head())
    # sentiment = [col for col in data.columns if col == 'sentiment']
    # sentiment_score = [col for col in data.columns if col == 'sentiment_score']
    # rating = [col for col in data.columns if col == 'Rating']
